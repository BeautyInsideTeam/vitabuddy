	        ...
	        <form id="joinForm" name="joinForm" method="post"  
	        	...
	        	<table>
                    ...
                    <tr>
		            	<th>주소</th>
		            	<td colspan="3">
		            		<input type="text" id="userZipcode" name="userZipcode" size="5"   value="${myInfo.userZipcode}" >
		            		<input type="button" id="searchZipBtn" name="searchZipBtn" value="우편번호 찾기"><br>
		            		<input type="text" id="userAddress1" name="userAddress1"  value="${myInfo.userAddress1}" placeholder="주소"  size="40" >
