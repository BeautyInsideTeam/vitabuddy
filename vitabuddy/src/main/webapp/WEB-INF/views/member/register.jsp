        ...
        <form onsubmit="return false;">
	        <div class="horizontal_box">
					...
					<div class="box_rowContents">
	               		...
	               		<button type="button" onclick="fnDbCheckId()" name="dbCheckId" class="btn" style="position:absolute; right: 29%; width: 6%;">중복확인</button>
           		 	</div>
					<p></p>
					<div class="box_rowContents">
		               <label>비밀번호 </label>
	                  ...
	                  <label>전화번호</label>
	               	...
	               	<div class="zipcode">
	               		<div class="box_rowContents">
			                  ...
			                  <button type="button" name="searchBtn" class="btn" onclick="openZipSearch()" style="position:absolute; right: 29%; width: 6%;">우편번호 찾기</button>  
	                    </div>    
			            <p></p>
			            <div class="box_rowContents">
			                  <label>주소</label>
