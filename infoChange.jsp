						...
						<form method="post" id="infomation"onsubmit="return false;">
							<div class="horizontal_box">
								...
								<select class="tellecom">
									...
									<input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"name="userPh1" id="userPh1"placeholder="010"maxlength="3" value="${getMember.getUserPh1() }" required/>
									 - 
									<input type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"name="userPh2" id="userPh2"placeholder="1111"maxlength="4" value="${getMember.getUserPh2() }" required/>
									 - 
									<input type="text"oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" name="userPh3" id="userPh3"placeholder="1234"maxlength="4" value="${getMember.getUserPh3() }"  required/>
								</div>
								<div class="zipcode">
									<label>우편번호 입력</label>
